...
def parameters(days, dx, fgw0, tcoe = 0, n = 5, k = 1.2167e-16, tau = None, Phi0 = 0, right_asc = '05 34 30.9',
               dec = '+22 00 53', eta = -1, psi = 0, Einstein_effect = False, Doppler_effect = False,
    ...
    Einstein_effect (bool): Einstein effect application (default = False) --
    ...
    par = {'tcoe': tcoe,
           ...
           'Einstein_effect': Einstein_effect,
...
class GW_signal:
    ...
    Attributes:
        ...
        Einstein_effect (bool): Einstein effect application
    ...
    Methods:
        ...
        EinsteinEffect: compute the Einstein effect and its influence on Phi(t) #[2, 3, 4]#
    ...
    def __init__(self, parameters):
        ...
        if isinstance(parameters['tcoe'], str):
            ...
            self.signal_date = self.UTCdate()                  # date (utc) of the GW signal generation
        ...
        self.Einstein_effect = parameters['Einstein_effect']   # Einstein effect application
    ...
    def UTCdate(self):
        """
        It computes the UTC-format date of the GW signal starting time if input tcoe is an int/float.
        """
    ...
    def EinsteinEffect():
        """
        Compute the Einstein effect and its influence on Phi(t).
        """
        
        return 1
    
    
    def Phi(self, plot = False):   # !!! inserire Einstein effect (here or in a method inside the class)
        """
