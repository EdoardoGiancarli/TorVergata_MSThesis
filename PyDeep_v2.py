# -*- coding: utf-8 -*-
"""
Created on Sun Jun 11 02:38:28 2023

@author: Edoardo Giancarli
"""

#### ModuleMSThesis - CNN for spectrograms classification version 2 ###############################################
...
import PyDns_v1 as pds                            # denoiser model
...
class GW_Deep(nn.Module):
    ...
    Parameters:
        ...
        denoiser_model (str, class object): denoiser model to apply, if the name is inserted (str) the model
...
class DeepTools:
    ...
    def test_model(self, test_dataset, model = None):
        ...
        return:
            mean_accuracy_test (float): mean accuracy value for the test dataset
        """
        ...
        print('The mean accuracy value for the test dataset is:')
