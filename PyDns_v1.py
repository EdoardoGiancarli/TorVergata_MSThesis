# -*- coding: utf-8 -*-
"""
Created on Fri Jun  2 00:13:01 2023

@author: Edoardo Giancarli
"""

#### ModuleMSThesis - Spectrograms Denoising version 1 ###############################################
...
import PySim_v2 as psm                          # signal simulation and injection
import PySpectr_v3 as psr                       # signals spectrograms
    ...
    for n in tqdm(range(N)):
        ...
        try:
            ...
            if len(np.where(y_clean == 0)[0])/len(y_clean) < 0.1:
                ...
                # spectrograms
                psr.spectr(ifftshift(y_clean), params['dt'], 1024, title = 'clean_spectr' + str(s),
                           images = True, directory = "D:/Home/Universita'/Universita'/Magistrale/Master Thesis/Tesi_Codes/Prova_Denoiser/Model_Test/Clean_imgs_test/")
                
                psr.spectr(ifftshift(y_noisy), params['dt'], 1024, title = 'noisy_spectr' + str(s),
                           images = True, directory = "D:/Home/Universita'/Universita'/Magistrale/Master Thesis/Tesi_Codes/Prova_Denoiser/Model_Test/Noisy_imgs_test/")
...
class DnsCNetTools:
    ...
    def test_model(self, test_dataset, model = None):
        ...
        return:
            mean_loss_test (float): mean loss value for the test dataset
        """
        ...
        self.mean_loss_test /= len(test_dataset.dataset)                  # test mean loss value
        
        return self.mean_loss_test
    ...
    def save_model(self, batch_size, epochs, learning_rate, filename):
        ...
        filepath = "D:/Home/Universita'/Universita'/Magistrale/Master Thesis/Tesi_Codes/Prova_Denoiser/"
