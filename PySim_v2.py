...
import PySpectr_v4 as psr                       # interferometer data
...
class GW_signal:
    ...
    def spectr(self, lfft = 1024, image = False, directory = None):
        ...
        if image: # spectrogram image
            ...
            plt.figure(num = None, figsize = (12, 12), tight_layout = True)             
            col_bar = plt.pcolormesh(t/86400, freq_trs, np.log10(spectr_trs),
                                     cmap='viridis', vmin = -13, vmax = -1, shading='gouraud')
...
class GW_injection:
    ...
    def spectr(self, lfft = 1024, image = False, directory = None):
        ...
        if image: # spectrogram image
            ...
            plt.figure(num = None, figsize=(12, 12), tight_layout = True)        
            plt.pcolormesh(t, freq, np.log10(spectr), cmap='viridis',
                           vmin = -13, vmax = -1, shading='gouraud')
            plt.axis('off')
            plt.title('')
            ...
            plt.figure(num = None, figsize = (12, 12), tight_layout = True)             
            col_bar = plt.pcolormesh(time, freq, np.log10(spectr),
                                     cmap='viridis', vmin = -13, vmax = -1, shading='gouraud')
            plt.colorbar(col_bar)
